...
class KasirSetoranController extends Controller
{
    ...
    public function stsBruto($bulan, $tahun, $jaminan)
    {
        ...
        $kepala    = $pimpinan['kepala'];
        $nipKepala = $pimpinan['nipKepala'];
        return view('Laporan.Kasir.stsBruto', compact('data', 'kepala', 'nipKepala', 'blnTahun', 'totalPendapatan', 'tglAkhir'))->with('title', $title);
    }
    public function stpbBruto($bulan, $tahun, $jaminan)
    {
        ...
        $kepala    = $pimpinan['kepala'];
        $nipKepala = $pimpinan['nipKepala'];
        return view('Laporan.Kasir.stpbBruto', compact('data', 'kepala', 'nipKepala', 'blnTahun', 'totalPendapatan', 'tglAkhir'))->with('title', $title);
    }
    ...
    public function retriBruto($bln, $tahun, $jaminan)
    {
        ...
        return view('Laporan.Kasir.retribusiBruto', compact('res', 'kepala', 'nipKepala', 'title', 'tglAwalIdn', 'tglAkhirIdn', 'tglAkhir', 'tahun'));
    }
