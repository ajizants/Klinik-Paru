...
class EkinController extends Controller
{
    public function index()
    {
        ...
        $hasilKegiatan = PegawaiKegiatanModel::with('user.biodata')->whereBetween('tanggal', [$tglAwal, $tglAkhir])->get();
    ...
    public function dataKegiatanLain($request)
    {
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $hasil = $this->dataKegiatanLain($request);
