                            ...
                            <div class="container-fluid row mx-0">
                                <div class=" col p-0 ml-1">
                                                ...
                                                <div class="row my-3 form-inline">
                                                    <div class="form-check form-switch col">
                                                        <a class="col-auto btn btn-success"
                                                            onclick="checkAll('frmHA')">Pemeriksaan</a>
                                                    </div>
                                                    <div class="col">
                                                ...
                                                <div class="row my-3">
                                                    <div class="form-check form-switch col form-inline">
                                                        <input class="form-check-input" type="checkbox"
                                                            role="switch" id="HA">
                                                        <label class="form-check-label" for="HA">HA 5
                                                            DIFF</label>
                                                    </div>
                                                    <div class="col-4">
                                    ...
                                    <div class="card card-info">
                                        ...
                                        <div class="card-body py-1">
                                            {{-- <a class="col btn btn-success" onclick="checkAll('frmHA')">Pilih Semua</a> --}}
                                            <form id="frmImuno">
                                                <div class="row my-3 form-inline">
                                                    <div class="form-check form-switch col">
                                                        <a class="col-auto btn btn-success"
