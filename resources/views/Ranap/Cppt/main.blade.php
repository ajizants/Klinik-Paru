...
@section('content')
    <div class="container-fluid">
        <div class="card card-secondary">
            ...
            <div class="card-body p-2">
                ...
                @include('Ranap.Cppt.identitas')

                <ul class="nav nav-tabs">
                    <li class="nav-item" style="height: 35px;">
                        <a type="button" class="nav-link active bg-blue"
                            onclick="toggleSections('#tab_1');"><b>CPPT</b></a>
                    </li>
                    <li class="nav-item" style="height: 35px;">
                        <a type="button" class="nav-link" onclick="toggleSections('#tab_2');"><b>Assesment
                                Awal</b></a>
                    </li>

                </ul>
                <div id="tab_1">
                    @include('Ranap.Cppt.kunjungan')
                </div>
    ...
    <script>
        $(function() {
            ...
            // Tes tab manual (jika kamu klik programmatically)
            // $('#custom-tabs-one-tab a[href="#nav-2"]').tab('show');
        });
        $(function() {
