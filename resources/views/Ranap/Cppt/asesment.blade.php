...
{{-- <h5 class="font-weight-bold text-center">Assesment Awal</h3> --}}
@csrf
<form id="form_asesment">
    ...
    <div class="form-row mb-2">
        <div class="col-md-4 pr-1 pl-0 pb-1">
            <select type="select" id="dxMedis_awal" class="form-control select2bs4 mb-2 border border-primary"
                required>
        ...
        <div class="col-md-4 pr-1 pl-0 pb-1">
            <select type="select" id="dxGizi_awal" class="form-control select2bs4 mb-2 border border-primary"
                required>
    ...
    <div class="form-row mb-2">
        ...
        <div class="col-md pr-1 pl-0 pb-1">
            <div class="input-group input-group-sm">
                <input type="text" id="energi" class="form-control" aria-describedby="inputGroup-sizing-sm"
                    placeholder="Energi" />
                <div class="input-group-append">
                    <div class="input-group-text">
                        kkal
        ...
        <div class="col-md pr-1 pl-0 pb-1">
            <div class="input-group input-group-sm">
                <input type="text" id="protein" class="form-control" aria-describedby="inputGroup-sizing-sm"
                    placeholder="Protein" />
                <div class="input-group-append">
                    <div class="input-group-text">
                        g
        ...
        <div class="col-md pr-1 pl-0 pb-1">
            <div class="input-group input-group-sm">
                <input type="text" id="lemak" class="form-control" aria-describedby="inputGroup-sizing-sm"
                    placeholder="lemak" />
                <div class="input-group-append">
                    <div class="input-group-text">
                        g
        ...
        <div class="col-md pr-1 pl-0 pb-1">
            <div class="input-group input-group-sm">
                <input type="text" id="karbohidrat" class="form-control" aria-describedby="inputGroup-sizing-sm"
