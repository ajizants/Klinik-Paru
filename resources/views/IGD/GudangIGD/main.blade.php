...
@section('content')
        ...
        <div class="card card-primary card-tabs">
            <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="bmhp-tab" data-toggle="pill" href="#bmhp" role="tab"
                            aria-controls="bmhp" aria-selected="true">BMHP & OBAT</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="tindakanMaster-tab" data-toggle="pill" href="#tindakanMaster" role="tab"
                            aria-controls="tindakanMaster" aria-selected="false">TINDAKAN</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <div class="tab-content" id="custom-tabs-one-tabContent">
                    <div class="tab-pane fade show active" id="bmhp" role="tabpanel" aria-labelledby="bmhp-tab">
                        @include('IGD.GudangIGD.bmhp')
                    </div>
                    <div class="tab-pane fade" id="tindakanMaster" role="tabpanel" aria-labelledby="tindakanMaster-tab">

                        @include('IGD.GudangIGD.tindakan')
                    </div>
                </div>
            </div>
            <!-- /.card -->
    ...
    <!-- my script -->
    <script src="{{ asset('js/templateNew.js') }}"></script>
