<div class="" id="tab_4" style="display: none;">
    <div class="container-fluid d-flex justify-content-center bg-warning border">
        <h5 class="m-2"><b>Rencana Kontrol Pasien / Data Dari RME</b></h5>
    </div>
    ...
    <div class="container-fluid d-flex justify-content-center bg-warning border">
        <h5 class="m-2"><b>Rencana Kontrol Pasien TBC / Data Dari Dots Center</b></h5>
    </div>
    <div class="table-responsive  mt-2" id="divRencanaKontrolTB">
        <table class="table table-bordered table-hover dataTable dtr-inline" cellspacing="0">
            <thead class="bg bg-info">
                <tr>
                    <th class="text-center">No</th>
