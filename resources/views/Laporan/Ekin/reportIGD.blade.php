<div class="card shadow mb-4">
    ...
    <div class="card-header py-1 bg bg-info">
        <h4 id="PoinJaspelSection" class="m-0 font-weight-bold text-light text-center">LAPORAN POIN
        </h4>
    </div>
    <div class="card-body">
...
<div class="d-flex justify-items-center">
    <div class="card shadow mb-4 p-0 col mx-1">
        <div class="card-header py-1 bg bg-info">
            <h4 id="DaftarTindakanSection" class="m-0 font-weight-bold text-light text-center">REPORT PETUGAS IGD
            </h4>
        </div>
        <div class="card-body">
            <div class="container">
    ...
    <div class="card shadow mb-4 p-0 col mx-1">
        <!-- Card Header - Accordion -->
        <div class="card-header py-1 bg bg-info">
            <h4 id="PoinSection" class="m-0 font-weight-bold text-light text-center">REPORT PETUGAS PELAYANAN
            </h4>
        </div>
...
<div class="d-flex justify-items-center">
    <div class="card shadow mb-4 p-0 col mx-1">
        <div class="card-header py-1 bg bg-info">
            <h4 id="PoinSection" class="m-0 font-weight-bold text-light text-center">REPORT PETUGAS DOTS CENTER
            </h4>
        </div>
        <div class="card-body">
            <div class="container">
    ...
    <div class="card shadow mb-4 p-0 col mx-1">
        <!-- Card Header - Accordion -->
        <a href="#collapseCardPoinLoket" class="d-block card-header py-1 bg bg-info" data-toggle="collapse"
            role="button" aria-expanded="true" aria-controls="collapseCardPoinLoket">
            <h4 id="PoinSection" class="m-0 font-weight-bold text-light text-center">REPORT PETUGAS PENDAFTARAN
            </h4>
        </a>
        <!-- Card Content - Collapse -->
        <div class="collapse show" id="collapseCardPoinLoket">
            <div class="card-body">
                <div class="container">
                    <div class="form-group">
                        @csrf
                        <form class="form-inline d-flex justify-content-start p-2">
                            ...
                            <input type="date" class="form-control bg bg-warning m-2" id="tgl_awal"
                                value="{{ date('Y-m-d') }}" required>
                            <label for="tgl_akhir" class="form-label"><b>Tanggal Akhir :</b></label>
                            <input type="date" class="form-control bg bg-warning m-2" id="tgl_akhir"
                                value="{{ date('Y-m-d') }}" required>
                            <a type="button" class="btn btn-success mx-2" onclick="reportPoinLoket();">Cari</a>
                        </form>
                        <div class="table-responsive pt-2 px-2">
                            <table id="reportLoket" name="reportLoket" class="table table-striped"
                                style="width:100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th class="">No</th>
                                        <th class="">Nama</th>
                                        <th class="col-3">Total Input Pasien</th>
                                        <th class="col-3">Input Pasien Lama</th>
                                        <th class="col-3">Input Pasien Baru</th>
                                    </tr>
                                </thead>
