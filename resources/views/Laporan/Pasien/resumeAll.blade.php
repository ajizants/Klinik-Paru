...
<body>
    @foreach ($semuaPasien as $data)
        <div class="container-fluid" style="height: 16in;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td width="30%" class="my-0 py-0" style=" text-align: left;">
                            {{ $data['resume']->pasien_no_rm }} / {{ $kunjungan }}
                        </td>
                        <td width="15%" class="my-0 py-0" style=" font-weight: bold; text-align: left;">
                            Umur
                        </td>
                    ...
                    <tr>
                        <td width="15%" class="my-0 py-0" style=" font-weight: bold; text-align: left;">
                            ...
                            Pasien / JK</td>
                        <td width="35%" class="my-0 py-0" style=" text-align: left;">
                            {{ $data['resume']->pasien_nama }} / {{ $data['resume']->jenis_kelamin_nama }}
                        </td>
                        <td width="15%" class="my-0 py-0" style=" font-weight: bold; text-align: left;">
                            Tanggal</td>
                        <td width="36%" class="my-0 py-0" style=" text-align: left;">
                            {{ Carbon\Carbon::parse($data['resume']->tanggal)->locale('id')->isoFormat('DD MMMM Y') }}
                        </td>
                    </tr>
                    <tr>
                        <td width="15%" class="my-0 py-0" style=" font-weight: bold; text-align: left;">
                        ...
                        <td width="25%" class="my-0 py-0" style="text-align: left;">
                            {{ Carbon\Carbon::parse($data['resume']->cppt_created_at)->format('H:i') }}
                            WIB
                        </td>
                    </tr>
                </tbody>
            ...
            <table class="table-borTL mb-0" width="100%">
                <tbody>
                        ...
                        <td rowspan="2" style="padding-left: 10px; text-align: left;">
                            ...
                            <div class="resume-container"
                                ...
                                <div style="flex: 1; text-align: left;">
                                    <li>TD: {{ $data['resume']->objek_tekanan_darah }} mmHg</li>
                                    <li>Suhu: {{ $data['resume']->objek_suhu }} °C</li>
                                    <li>BB: {{ $data['resume']->objek_bb }} kg</li>
                                </div>

                                <div style="flex: 1; text-align: left;">
                                    <li>Nadi: {{ $data['resume']->objek_nadi }} x/mnt</li>
                                    <li>RR: {{ $data['resume']->objek_rr }} x/mnt</li>
                                </div>
                            </div>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="my-0 py-0" style="width: 50%; text-align: left;">
                            {{ $data['resume']->objek_data_objektif }}
                        </td>
                    </tr>
                </tbody>
            </table>
                            ...
                            <div class="d-flex justify-between">
                                <div class="col text-center">
                                    <li style="margin-left: 38px; text-align: justify;">
                                        {{ $data['resume']->status_pasien_pulang }},
                                    </li>
                                    <li style="margin-left: 38px; text-align: justify;">
                                        {{ $data['resume']->ket_status_pasien_pulang }}
                                    </li>
                                </div>
                                <div class="col text-center">
                                    @if ($data['resume']->rencana_tindak_lanjut != '-')
                                        <li style="margin-left: 38px; text-align: justify;">
                                            {{ $data['resume']->rencana_tindak_lanjut }}
                                        </li>
                                    @endif
                                </div>
                                <div class="col text-center">
                        ...
                        <tr>
                            <td colspan="4" class="py-2" style="text-align: right;">
                                <div
                                    ...
                                    <br>
                                    <br>
                                    @if ($data['resume']->dokter_nama == 'dr. AGIL DANANJAYA, Sp.P')
                                        {{ $data['resume']->dokter_nama }}
                                        <br>
                                        SIP. 3302/53127/03/449.1/100/DS/B/IV/2023
                                    @elseif ($data['resume']->dokter_nama == 'dr. Cempaka Nova Intani, Sp.P, FISR., MM.')
                                        {{ $data['resume']->dokter_nama }}
                                        <br>
