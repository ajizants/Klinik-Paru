<div class="card shadow mb-4">
    ...
    <a href="#collapseCardAntrian" class="d-block card-header py-1 bg bg-info" data-toggle="collapse" role="button"
        ...
        <h4 id="antrianSection" class="m-0 font-weight-bold text-dark text-center">Antrian Kasir</h4>
    </a>
    <!-- Card Content - Collapse -->
    <div class="collapse show" id="collapseCardAntrian">
        <div class="col-6 d-flex justify-content-center z-3 position-absolute">
            <div class="input-group col-4 form-inline col-2">
                    ...
                    <table id="dataAntrian" class="table table-striped pt-0 mt-0 fs-6" style="width:100%"
                        ...
                        <thead class="bg bg-teal">
                            <tr>
                                ...
                                <th width="40px" class="text-center">NoRM</th>
