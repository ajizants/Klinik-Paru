...
<body class="text-black">
    <div class="wrapper m-3 pt-2">
        <h1 class="text-center font-bold">REKAP LAPORAN KEGIATAN HARIAN RONTGEN</h1>
        <h2 class="text-center font-bold">PELAYANAN DI KLINIK UTAMA KESEHATAN PARU MASYARAKAT KELAS A KAB. BANYUMAS</h2>
        <h3 class="text-center font-bold">Bulan: {{ $blnTahun }}</h3>
