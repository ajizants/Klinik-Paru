...
function listKominfo(tglAwal, tglAkhir) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            // console.log("🚀 ~ listKominfo ~ total:", total);
            // console.log("🚀 ~ listKominfo ~ $data:", pendaftaran);
            ...
            pendaftaran.forEach(function (item, index) {
                ...
                item.aksi = `
                            ...
                            <button type="button" class="btn btn-sm btn-${item.check_in} mr-2 mb-2" id="checkin" placeholder="Submit" data-toggle="modal"
