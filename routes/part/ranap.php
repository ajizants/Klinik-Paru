...
<?php
    ...
    Route::delete('/ranap/delete_tindakan/{id}', [RanapCPPTController::class, 'delete_tindakan']);

    Route::post('/ranap/order_penunjang', [RanapCPPTController::class, 'order_penunjang']);
    Route::delete('/ranap/delete_penunjang/{id}', [RanapCPPTController::class, 'delete_penunjang']);
